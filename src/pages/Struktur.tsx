  ...
  return (
    <div className="space-y-8 p-6">
      ...
      <div>
        ...
        <p className="text-slate-400 text-sm mt-1">Pengurus kelas X-6</p>
      </div>
      ...
      {waliKelas.nama ? (
          ...
          <div className="flex justify-center">
            <div className="flex flex-col items-center gap-3">
              <div className="relative">
                ...
                <img src={waliKelas.foto} alt={waliKelas.nama} className="relative w-24 h-24 rounded-3xl object-cover ring-2 ring-blue-500/50 glow-blue" />
              </div>
        ...
        <div className="glass rounded-2xl p-6 border border-white/5 text-center">
          ...
          <p className="text-sm text-slate-500">Data wali kelas belum diisi.</p>
        </div>
      )}
            ...
            return (
              <div key={p.nis || p.nama} className={`glass rounded-2xl p-5 border bg-gradient-to-br ${cls.split(" ")[0]} ${cls.split(" ")[1]} flex flex-col items-center gap-3 w-52`}>
                ...
                <div className="text-center">
                  ...
                  {p.nis && <p className="text-xs text-slate-500">NIS: {p.nis}</p>}
              ...
              return (
                <div key={p.nis || p.nama} className={`glass rounded-2xl p-4 border bg-gradient-to-br ${cls.split(" ")[0]} ${cls.split(" ")[1]} flex flex-col items-center gap-3 glass-hover`}>
                  ...
                  <div className="text-center">
                    ...
                    {p.nis && <p className="text-xs text-slate-600 mt-0.5">NIS: {p.nis}</p>}
                    {siswa && <p className="text-xs text-slate-500 mt-0.5">Nilai: <span className="text-white font-semibold">{siswa.nilaiRata}</span></p>}
                  </div>
                </div>
              );
      ...
      <div className="glass rounded-2xl border border-white/5 overflow-hidden">
        ...
        {siswaList.length === 0 ? (
          <p className="text-xs text-slate-600 text-center py-10">Belum ada data siswa.</p>
        ) : (
