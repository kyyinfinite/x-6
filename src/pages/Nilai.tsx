    ...
    <div className="space-y-6 p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="glass rounded-2xl p-5 border border-green-500/15 bg-gradient-to-br from-green-500/8 to-transparent">
          ...
          ) : <p className="text-sm text-slate-600 mt-2">Belum ada data</p>}
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div className="glass rounded-2xl p-5 border border-white/5">
          ...
          {radarData.length === 0 ? (
            <p className="text-xs text-slate-600 text-center py-16">Belum ada data nilai mata pelajaran.</p>
          ) : (
        ...
        <div className="glass rounded-2xl p-5 border border-white/5">
          ...
          {top5.length === 0 ? (
            <p className="text-xs text-slate-600 text-center py-8">Belum ada data nilai siswa.</p>
          ) : (
      ...
      <div className="glass rounded-2xl border border-white/5 overflow-hidden">
        ...
        {nilaiMapel.length === 0 ? (
          <p className="text-xs text-slate-600 text-center py-10">Belum ada data nilai.</p>
        ) : (
